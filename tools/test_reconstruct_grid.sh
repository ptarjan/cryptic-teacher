...
# is not a puzzle) and update it. 14 = cryptic at five sizes, cyclops at two,
# and book, everyman, globeandmail, independent, indysunday, metro and quiptic
# at one each. Every scanned printed book is the one `book` series, so a
