...
LAYOUT = [
    ...
    ("building and checking the site", "tools/test_ci_coverage.js", "checks every test in tools/ is run by the workflow a later push cannot cancel, so no check is quietly optional"),
