...
window.CRYPTIC_PUZZLES["independent-12432"] = /*JSON-START*/ {
    ...
    "blocks": [
     {
      ...
      "soundsLike": "BLUE",
      "gives": "BLEW",
      "note": "down in the sense of gloomy is BLUE"
     }
    ],
    ...
    "blocks": [
     {
      ...
      "soundsLike": "MY NEWT",
      "gives": "MINUTE",
      "note": "the amphibian is a NEWT and it belongs to ME, so 'my newt' — which run together is the answer"
     }
    ],
