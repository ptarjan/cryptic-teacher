...
<p>Setters lean on a shared stock of tiny substitutions. These never change, so they are worth looking up once and owning forever — all 420 of the ones this site's clues use:</p>
...
<tr><td id="abbr-europe">europe</td><td>EU</td><td id="abbr-european">european</td><td>E</td><td id="abbr-europeans">europeans</td><td>EU</td></tr>
<tr><td id="abbr-exercise">exercise</td><td>PE</td><td id="abbr-extra-large">extra large</td><td>XL</td><td id="abbr-fashionable">fashionable</td><td>IN</td></tr>
<tr><td id="abbr-father">father</td><td>PA</td><td id="abbr-feet">feet</td><td>FT</td><td id="abbr-fellow">fellow</td><td>F</td></tr>
<tr><td id="abbr-female">female</td><td>F</td><td id="abbr-fifty">fifty</td><td>L</td><td id="abbr-fine">fine</td><td>F, OK</td></tr>
<tr><td id="abbr-firm">firm</td><td>CO</td><td id="abbr-five">five</td><td>V</td><td id="abbr-five-hundred">five hundred</td><td>D</td></tr>
<tr><td id="abbr-flatten">flatten</td><td>KO</td><td id="abbr-following">following</td><td>F</td><td id="abbr-foot">foot</td><td>FT</td></tr>
<tr><td id="abbr-for-example">for example</td><td>EG</td><td id="abbr-for-instance">for instance</td><td>EG</td><td id="abbr-former">former</td><td>EX</td></tr>
<tr><td id="abbr-forte">forte</td><td>F</td><td id="abbr-forty">forty</td><td>XL</td><td id="abbr-four">four</td><td>IV</td></tr>
<tr><td id="abbr-franc">franc</td><td>F</td><td id="abbr-function">function</td><td>F</td><td id="abbr-games">games</td><td>PE</td></tr>
<tr><td id="abbr-german">german</td><td>G</td><td id="abbr-gold">gold</td><td>OR</td><td id="abbr-golf">golf</td><td>G</td></tr>
...
<tr><td id="abbr-new-york">new york</td><td>NY</td><td id="abbr-nine">nine</td><td>IX</td><td id="abbr-noon">noon</td><td>N</td></tr>
<tr><td id="abbr-north">north</td><td>N</td><td id="abbr-north-american">north american</td><td>NA</td><td id="abbr-north-eastern">north eastern</td><td>NE</td></tr>
<tr><td id="abbr-northeast">northeast</td><td>NE</td><td id="abbr-northern">northern</td><td>N</td><td id="abbr-northwest">northwest</td><td>NW</td></tr>
<tr><td id="abbr-not-applicable">not applicable</td><td>NA</td><td id="abbr-note">note</td><td>E, LA, ME, MI, N, NB, RE, SO, TE</td><td id="abbr-note-well">note well</td><td>NB</td></tr>
<tr><td id="abbr-nothing">nothing</td><td>O</td><td id="abbr-november">november</td><td>N</td><td id="abbr-nuclear">nuclear</td><td>N</td></tr>
<tr><td id="abbr-number">number</td><td>N, NO</td><td id="abbr-obiit">obiit</td><td>OB</td><td id="abbr-ohio">ohio</td><td>O</td></tr>
<tr><td id="abbr-old">old</td><td>O</td><td id="abbr-old-boy">old boy</td><td>OB</td><td id="abbr-old-english">old english</td><td>OE</td></tr>
<tr><td id="abbr-old-flame">old flame</td><td>EX</td><td id="abbr-one">one</td><td>A, I, UN</td><td id="abbr-operation">operation</td><td>OP</td></tr>
<tr><td id="abbr-opus">opus</td><td>OP</td><td id="abbr-ordinary">ordinary</td><td>O</td><td id="abbr-other-ranks">other ranks</td><td>OR</td></tr>
<tr><td id="abbr-out-of">out of</td><td>EX</td><td id="abbr-outsize">outsize</td><td>OS</td><td id="abbr-over">over</td><td>O</td></tr>
<tr><td id="abbr-oxygen">oxygen</td><td>O</td><td id="abbr-page">page</td><td>P</td><td id="abbr-parking">parking</td><td>P</td></tr>
<tr><td id="abbr-peacekeepers">peacekeepers</td><td>UN</td><td id="abbr-pee">pee</td><td>P</td><td id="abbr-pence">pence</td><td>P</td></tr>
<tr><td id="abbr-penny">penny</td><td>D, P</td><td id="abbr-per-annum">per annum</td><td>PA</td><td id="abbr-physical-training">physical training</td><td>PT</td></tr>
<tr><td id="abbr-piano">piano</td><td>P</td><td id="abbr-pint">pint</td><td>PT</td><td id="abbr-place">place</td><td>PL</td></tr>
<tr><td id="abbr-playing">playing</td><td>ON</td><td id="abbr-point">point</td><td>PT</td><td id="abbr-police">police</td><td>MP</td></tr>
<tr><td id="abbr-policeman">policeman</td><td>PC</td><td id="abbr-politically-correct">politically correct</td><td>PC</td><td id="abbr-politician">politician</td><td>MP</td></tr>
<tr><td id="abbr-post-office">post office</td><td>PO</td><td id="abbr-postscript">postscript</td><td>PS</td><td id="abbr-potassium">potassium</td><td>K</td></tr>
<tr><td id="abbr-pound">pound</td><td>L, LB</td><td id="abbr-power">power</td><td>P</td><td id="abbr-president">president</td><td>P</td></tr>
<tr><td id="abbr-pressure">pressure</td><td>P</td><td id="abbr-prime-minister">prime minister</td><td>PM</td><td id="abbr-printer-s-measure">printer's measure</td><td>EN</td></tr>
<tr><td id="abbr-professional">professional</td><td>PRO</td><td id="abbr-promotion">promotion</td><td>AD</td><td id="abbr-public-address">public address</td><td>PA</td></tr>
<tr><td id="abbr-publicity">publicity</td><td>PR</td><td id="abbr-queen">queen</td><td>ER, Q, QU, R</td><td id="abbr-question">question</td><td>Q</td></tr>
<tr><td id="abbr-quiet">quiet</td><td>P</td><td id="abbr-race">race</td><td>TT</td><td id="abbr-raised">raised</td><td>UP</td></tr>
<tr><td id="abbr-rare">rare</td><td>R</td><td id="abbr-recipe">recipe</td><td>R</td><td id="abbr-record">record</td><td>CD, LP</td></tr>
<tr><td id="abbr-refusal">refusal</td><td>NO</td><td id="abbr-republican">republican</td><td>R</td><td id="abbr-riding">riding</td><td>UP</td></tr>
<tr><td id="abbr-right">right</td><td>R</td><td id="abbr-ring">ring</td><td>O</td><td id="abbr-river">river</td><td>R</td></tr>
<tr><td id="abbr-road">road</td><td>RD</td><td id="abbr-rugby">rugby</td><td>RU</td><td id="abbr-run">run</td><td>R</td></tr>
<tr><td id="abbr-run-out">run out</td><td>RO</td><td id="abbr-runs">runs</td><td>R</td><td id="abbr-r-sum">résumé</td><td>CV</td></tr>
...
<tr><td id="abbr-we">we</td><td>US</td><td id="abbr-week">week</td><td>W</td><td id="abbr-weight">weight</td><td>KG, LB</td></tr>
<tr><td id="abbr-west">west</td><td>W</td><td id="abbr-whiskey">whiskey</td><td>W</td><td id="abbr-wife">wife</td><td>W</td></tr>
<tr><td id="abbr-with">with</td><td>W</td><td id="abbr-without">without</td><td>SP</td><td id="abbr-woman">woman</td><td>MS</td></tr>
<tr><td id="abbr-women">women</td><td>W</td><td id="abbr-work">work</td><td>OP</td><td id="abbr-working">working</td><td>ON</td></tr>
<tr><td id="abbr-wrong">wrong</td><td>X</td><td id="abbr-yard">yard</td><td>Y</td><td id="abbr-year">year</td><td>Y</td></tr>
<tr><td id="abbr-yen">yen</td><td>Y</td><td id="abbr-yours-truly">yours truly</td><td>ME</td><td id="abbr-zed">zed</td><td>Z</td></tr>
</table>
<!-- ABBREVIATIONS-END -->
...
<h3 id="notation">Reading other people's explanations</h3>
<p>Every daily broadsheet cryptic gets blogged, clue by clue, by solvers who
   explain the whole grid the morning after — Fifteensquared covers the Guardian
   and the Independent, Big Dave's the Telegraph, Times for the Times the Times.
   They are the best free resource in the hobby and the natural place to go for a
   puzzle we do not hold. But they all write in a shorthand nobody explains,
   because it grew up among people who already knew it, and it stops beginners
   before the wordplay ever gets a chance to. Here it is:</p>
<table>
  <tr><th>You'll see</th><th>It means</th></tr>
  <tr><td><u>underlined</u></td><td>the definition</td></tr>
  <tr><td>CAPITALS</td><td>the fodder — the letters actually being worked on</td></tr>
  <tr><td>(brackets)</td><td>the indicator, quoted from the clue</td></tr>
  <tr><td>[square brackets]</td><td>letters deleted, or the instruction that deletes them</td></tr>
  <tr><td>*</td><td>anagram — <em>RETAIL*</em> means "anagram of RETAIL"</td></tr>
  <tr><td>&lt;, &lt;&lt;, rev</td><td>reversed</td></tr>
  <tr><td>dd</td><td>double definition</td></tr>
  <tr><td>cd</td><td>cryptic definition — the whole clue is one sly definition</td></tr>
  <tr><td>&amp;lit</td><td>the whole clue is both the definition and the wordplay</td></tr>
  <tr><td>lift and separate</td><td>read two words that look like a phrase as two
      separate words — "flowerbed" as "flower" then "bed"</td></tr>
  <tr><td>Ximenean / libertarian</td><td>strict about the rules, or relaxed about
      them; setters are argued over on this axis</td></tr>
</table>
<p>So a blogger writes <em><u>Chaperone</u> gets (shredded) CORSET* = ESCORT</em>,
   and that is exactly what the rungs here would have told you one at a time:
   the definition is "Chaperone", the indicator is "shredded", the fodder is
   "corset". Same explanation, denser dialect. Once the shorthand reads as
   English, every blog in the hobby opens up.</p>
`;
