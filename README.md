...
**Corpus** — 524 puzzles across 5 series (Guardian cryptic 194, Independent Sunday 95, Independent daily 79, Observer Everyman 79, Guardian Quiptic 77). 359 of them are annotated clue-for-clue, all six rungs, machine-validated: 10,528 of 15,314 clues, or 69%. The rest are backlog the daily job is still draining — they show an <em>auto hints</em> badge and degrade gracefully (checking and letter reveals still work; the teaching ladder appears once a puzzle is annotated).
<!-- CORPUS-END -->
